    ...
    <div class="innerHeader">
        <div class="leftHeader">
            ...
            <div class="containerForSuggestions">
                <input class="searchBarHeader" type="text" id="textfield" oninput="showSuggestions()" placeholder="Søk etter funksjon her">
...
var suggestions = [
    { name: "Pengeinnkreving", description: "Pengeinnkreving er en funksjon" },
    { name: "Streetrace", description: "Streetrace er en funksjon" },
    { name: "Kriminalitet", description: "Kriminalitet er en funksjon" },
    { name: "Biltyveri", description: "Biltyveri er en funksjon" },
];
